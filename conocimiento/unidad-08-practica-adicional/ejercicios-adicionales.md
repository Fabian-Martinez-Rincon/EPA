...
```
{1. Escriba un programa que le permita al robot recorrer todas las avenidas de la ciudad. 
Cada avenida debe recorrerse sólo hasta encontrar una esquina vacía (sin flor ni 
papel) que seguro existe. Además a medida que se recorre cada avenida debe 
informar si la misma tuvo a lo sumo 45 flores (hasta que encontró la esquina). 
Nota: Se debe usar Modularización. 
>Sí: “a lo sumo” = “como mucho” = “como máximo” = “máximo”.
}
