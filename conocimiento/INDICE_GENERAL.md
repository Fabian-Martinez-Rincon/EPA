...
| 2 | Sección "Ejercitación" de [unidad-02](<unidad-02-algoritmos-y-logica/capitulo-2-algoritmos-y-logica.md>) | 7 de 12 ejercicios atomizados uno por archivo en [ejercicios/](unidad-02-algoritmos-y-logica/ejercicios/) + [soluciones/](unidad-02-algoritmos-y-logica/soluciones/) (2, 4, 6, 7, 9, 11, 12); el resto del código sigue en [codigo/](unidad-02-algoritmos-y-logica/codigo/) (vinculación parcial por nombre; ver nota de procedencia) |
| 3 | Sección "Ejercitación" de [unidad-03](<unidad-03-datos/capitulo-3-datos.md>) | 8 de 10 ejercicios atomizados en [ejercicios/](unidad-03-datos/ejercicios/) + [soluciones/](unidad-03-datos/soluciones/) (2-6, 8-10); resto en [codigo/](unidad-03-datos/codigo/) |
| 4 | Sección "Ejercitación" de [unidad-04](<unidad-04-repaso/capitulo-4-repaso.md>) | 2 de 5 ejercicios con código atomizados en [ejercicios/](unidad-04-repaso/ejercicios/) + [soluciones/](unidad-04-repaso/soluciones/) (4, 5); resto en [codigo/soluciones/capitulo-04](unidad-04-repaso/codigo/soluciones/capitulo-04/) |
| 5 | Sección "Ejercitación" de [unidad-05](<unidad-05-programacion-estructurada/capitulo-5-programacion-estructurada.md>) | 4 de 11 ejercicios atomizados en [ejercicios/](unidad-05-programacion-estructurada/ejercicios/) + [soluciones/](unidad-05-programacion-estructurada/soluciones/) (1-4); resto en [codigo/ejemplos/modularizacion](unidad-05-programacion-estructurada/codigo/ejemplos/modularizacion/), [codigo/soluciones/capitulo-05](unidad-05-programacion-estructurada/codigo/soluciones/capitulo-05/) |
| 6 | Sección "Ejercitación" de [unidad-06](<unidad-06-parametros-de-entrada/capitulo-6-parametros-de-entrada.md>) | Los 8 ejercicios de la ejercitación atomizados en [ejercicios/](unidad-06-parametros-de-entrada/ejercicios/) + [soluciones/](unidad-06-parametros-de-entrada/soluciones/); ejemplos de apoyo sin atomizar en [codigo/ejemplos/parametros-entrada](unidad-06-parametros-de-entrada/codigo/ejemplos/parametros-entrada/) |
| 7 | Sección "Ejercitación" de [unidad-07](<unidad-07-parametros-de-entrada-salida/capitulo-7-parametros-de-entrada-salida.md>) | 2 de 6 ejercicios atomizados en [ejercicios/](unidad-07-parametros-de-entrada-salida/ejercicios/) + [soluciones/](unidad-07-parametros-de-entrada-salida/soluciones/) (5, 6); resto en [codigo/ejemplos/parametros-entrada-salida](unidad-07-parametros-de-entrada-salida/codigo/ejemplos/parametros-entrada-salida/), [codigo/soluciones/capitulo-07](unidad-07-parametros-de-entrada-salida/codigo/soluciones/capitulo-07/) |
| 8 | [ejercicios-adicionales.md](<unidad-08-practica-adicional/ejercicios-adicionales.md>) | Los 3 ejercicios con código (1-3) atomizados en [ejercicios/](unidad-08-practica-adicional/ejercicios/) + [soluciones/](unidad-08-practica-adicional/soluciones/), también detallados en [practica-guiada.md](unidad-08-practica-adicional/practica-guiada.md); 4 a 8 sin solución en el repositorio |
...
- **Atomización de las unidades 02 a 08 (siguiendo la misma convención que `AYP1-FABOSISTEMAS`):** cada unidad con código R-info tiene ahora un subconjunto de sus ejercicios atomizados uno por archivo en `ejercicios/` (enunciado con front matter) y `soluciones/` (análisis, estrategia, casos límite, errores frecuentes), en vez de vivir solo embebidos en el capítulo. La cobertura no es del 100% en ninguna unidad a propósito: cada ejercicio se verificó contra su propio enunciado (aplicando la regla de orientación del robot descripta en la unidad 2) antes de atomizarlo, y el código que resultó implementar un problema distinto al de su enunciado quedó señalado como pendiente en vez de reescribirse — nunca se inventó una solución nueva sobre contenido `origen: convertido`. En el proceso se encontraron y corrigieron ~10 bugs puntuales (típicamente una palabra o una condición: flor↔papel confundido, una negación invertida, un `repetir N` con el número equivocado, un `Informar` faltante) y también dos vacíos reales en el intérprete de R-info construido para `Academia-Fabo` (procesos sin parámetros declarados/invocados sin paréntesis). El detalle exacto de qué se atomizó, qué se corrigió y qué quedó pendiente en cada unidad está en el `README.md` de esa unidad, no se repite acá:
  - [unidad-02-algoritmos-y-logica/README.md](unidad-02-algoritmos-y-logica/README.md) — 7 de 12 ejercicios (2, 4, 6, 7, 9, 11, 12).
  - [unidad-03-datos/README.md](unidad-03-datos/README.md) — 8 de 10 ejercicios (2-6, 8-10).
  - [unidad-04-repaso/README.md](unidad-04-repaso/README.md) — 2 de 5 ejercicios con código (4, 5).
  - [unidad-05-programacion-estructurada/README.md](unidad-05-programacion-estructurada/README.md) — 4 de 11 ejercicios (1-4).
  - [unidad-06-parametros-de-entrada/README.md](unidad-06-parametros-de-entrada/README.md) — los 8 ejercicios de la ejercitación.
  - [unidad-07-parametros-de-entrada-salida/README.md](unidad-07-parametros-de-entrada-salida/README.md) — 2 de 6 ejercicios (5, 6).
  - [unidad-08-practica-adicional/README.md](unidad-08-practica-adicional/README.md) — los 3 ejercicios con código (1-3).
  
  Es la estructura que lee [Academia-Fabo](https://github.com/Fabian-Martinez-Rincon/Academia-Fabo) para mostrar cada ejercicio con un runner de R-info (intérprete propio, no el `.jar` original) en el navegador.
