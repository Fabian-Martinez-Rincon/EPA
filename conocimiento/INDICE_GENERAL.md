...
- **Atomización de unidad-02 (siguiendo la misma convención que `AYP1-FABOSISTEMAS`):** los ejercicios 2, 4, 6, 7, 9, 11 y 12 tienen ahora un archivo por ejercicio en `ejercicios/` (enunciado con front matter) y `soluciones/` (análisis, estrategia, casos límite, errores frecuentes), en vez de vivir solo embebidos en `capitulo-2-algoritmos-y-logica.md`. Al hacerlo se encontraron y corrigieron 3 bugs puntuales en el código histórico (`ejercicio-02.ri`, `ejercicio-09.ri`, `ejercicio-12.ri` — ver detalle en cada solución y en el `README.md` de la unidad); los ejercicios 8 y 10, y las variantes `ejercicio-07-1.ri`/`-07-4.ri`/`-07-5.ri`, resultaron implementar un problema distinto al de su propio enunciado y quedaron señalados como pendientes en vez de reescribirse. Los ejercicios 1, 3 y 5 siguen sin código identificado. Las unidades 03 a 08 todavía no pasaron por esta atomización.
