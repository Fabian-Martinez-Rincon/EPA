...
| 2 | Sección "Ejercitación" de [unidad-02](<unidad-02-algoritmos-y-logica/capitulo-2-algoritmos-y-logica.md>) | [codigo/soluciones/capitulo-02](unidad-02-algoritmos-y-logica/codigo/soluciones/capitulo-02/) (vinculación parcial por nombre; ver nota de procedencia) |
| 3 | Sección "Ejercitación" de [unidad-03](<unidad-03-datos/capitulo-3-datos.md>) | [codigo/soluciones/capitulo-03](unidad-03-datos/codigo/soluciones/capitulo-03/) |
...
- La vinculación de soluciones históricas de la unidad 2 es parcial a propósito: los archivos sin extensión con nombres ambiguos (`10OHNO`, `KK`, `LACONCHADEMIMADRE`, etc.) no se relacionaron con un ejercicio específico por falta de evidencia suficiente, para no inventar una correspondencia. Quedan disponibles para revisión manual en [unidad-02-algoritmos-y-logica/codigo/soluciones/capitulo-02](unidad-02-algoritmos-y-logica/codigo/soluciones/capitulo-02/).
