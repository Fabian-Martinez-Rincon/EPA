...
![Figura original 5.1: descomposición Top-Down](assets/figura-5-1-top-down-original.png)
...
![Figura original 5.2: diseño Top-Down para realizar una avenida](assets/figura-5-2-top-down-original.png)
...
![Figura original 5.3: diseño Top-Down del recorrido de avenidas](assets/figura-5-3-top-down-original.png)
...
![Figura original 5.4: diseño Top-Down para avenidas pares e impares](assets/figura-5-4-top-down-original.png)
...
![Figura original 5.7: descomposición Top-Down del recorrido de 25 manzanas](assets/figura-5-7-top-down-original.png)
...
![Figura original 5.8: descomposición Top-Down para recorrer todas las esquinas](assets/figura-5-8-top-down-original.png)
...
2. Utilice el proceso desarrollado en 1. para realizar un programa para cada uno de los recorridos de la figura 5.9.
   ...
   **Figura 5.9: Recorridos usando cuadrados de lado 2**
   ...
   ![Figura 5.9: dos recorridos construidos con cuadrados de lado 2](assets/figura-5-9-recorridos-cuadrados.png)
...
4. Programe al Robot para que realice los recorridos de la figura 5.10 utilizando el proceso desarrollado en 3.
   ...
   **Figura 5.10: Recorridos usando rectángulos de 5x3**
   ...
   ![Figura 5.10: tres recorridos construidos con rectángulos de 5 por 3](assets/figura-5-10-recorridos-rectangulos.png)
...
11. Programe al Robot para que realice el recorrido de la figura 5.11 utilizando un proceso que permita hacer un escalón.
    ...
    **Figura 5.11: Recorrido en escalera de tres escalones**
    ...
    ![Figura 5.11: recorrido en escalera de tres escalones](assets/figura-5-11-recorrido-escalera.png)
...
|---|---|
| 1 | [Cap5_1](../../soluciones/por-capitulo/capitulo-05/Cap5_1) |
| 2 | [variante A](../../soluciones/por-capitulo/capitulo-05/Cap5_2A), [variante B](../../soluciones/por-capitulo/capitulo-05/Cap5_2B) |
| 3 | [Cap5_3](../../soluciones/por-capitulo/capitulo-05/Cap5_3) |
| 4 | [variante A](../../soluciones/por-capitulo/capitulo-05/Cap5_4A), [variante B](../../soluciones/por-capitulo/capitulo-05/Cap5_4B), [variante C](../../soluciones/por-capitulo/capitulo-05/Cap5_4C), [variante C alternativa](<../../soluciones/por-capitulo/capitulo-05/Cap5_4C otro>) |
| 8 | [Cap 5_8](<../../soluciones/por-capitulo/capitulo-05/Cap 5_8>) |

También hay ejemplos modernos de modularización: [código modularizado](../../ejemplos/modularizacion/codigo_modularizado.ri), [ejemplo 1](../../ejemplos/modularizacion/ejemplo_1.ri), [ejemplo 2](../../ejemplos/modularizacion/ejemplo_2.ri), [ejemplo 3](../../ejemplos/modularizacion/ejemplo_3.ri), [ejemplo 4](../../ejemplos/modularizacion/ejemplo_4.ri) y [ejemplo 5](../../ejemplos/modularizacion/ejemplo_5.ri).
